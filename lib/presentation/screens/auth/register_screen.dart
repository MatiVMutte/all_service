...
class SignUpScreen extends ConsumerWidget {
  ...
  Container register(Size size, ColorScheme theme, double bordeRedondeado) {
    return Container(
      // width: size.width,
      // height: size.height,
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 20),
        child: SingleChildScrollView(child: _FormRegister()),
      ),
    );
  }
        ...
        body: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              //* LogIn
              Expanded(child: register(size, theme, bordeRedondeado)),
            ],
          ),
        ));
  }
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: inputDecoration(
              "Ingrese su nombre", Icons.person, context),
        ),
